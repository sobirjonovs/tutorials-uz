        ...
        "language": {
          ...
          <div class="card shadow mb-4">
            <div class="d-flex justify-content-between card-header py-3">
              <h6 class="mt-2 font-weight-bold text-primary">Blog kategoriyalar ro'yhati</h6><!-- Button trigger modal -->
				  ...
				  <div class="modal-dialog" role="document">
				    <div class="modal-content">
				      <div class="modal-header">
				        <h5 class="modal-title" id="exampleModalLabel">Blog kategoriya qo'shish</h5>
